...
define(function () {
    ...
    function modelBase(id, attributes, options) { // Extended with attributes and options for Backbone adopted functionality
        ...
        Main.noConflict = function() {
            console.log('CORE: modelBase noConflict() called');
            Main = previousMain;
            return this;
        };
		...
		var Events = Main.Events = {
			...
			stopListening: function(obj, name, callback) {
				console.log('CORE: modelBase Events stopListening(obj, name, context) called');
		...
		var triggerEvents = function(events, args) {
			console.log('CORE: modelBase Events triggerEvents(events, args) called');
		...
		var Model = Main.Model = function(attributes, options) {
			console.log('CORE: modelBase Model(attributes, options) called');
			console.log('CORE: modelBase Model(attributes, options) attributes = ');
			console.log(attributes);
			console.log('CORE: modelBase Model(attributes, options) options = ');
			console.log(options);
		...
		Main.sync = function(method, model, options) {
			console.log('CORE: modelBase sync(method, model, options) called');
			console.log('CORE: modelBase sync(method, model, options) method = ');
			console.log(method);
			console.log('CORE: modelBase sync(method, model, options) model = ');
			console.log(model);	
			console.log('CORE: modelBase sync(method, model, options) options = ');
			console.log(options);
		...
		Main.ajax = function() {
			console.log('CORE: modelBase ajax() called');
        ...
        var urlError = function() {
            console.log('CORE: modelBase urlError() called');            
            throw new Error('A "url" property or function must be specified');
        };
        // Adopted from Backbone
        // Wrap an optional error callback with a fallback error event.
        var wrapError = function(model, options) {
            console.log('CORE: modelBase wrapError(model, options) called');            
